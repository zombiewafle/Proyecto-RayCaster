...
class GameState():
    ...
    def intro(self):    
        ...
        screen.blit(menuIMG, (-200,0))
        #screen.blit(menu, (-50,0))
        #screen.blit(menu, (700,0))
        drawText('Wolfenstein', font, pygame.Color("white"), screen, 150,100)
        drawText('New Order', font, pygame.Color("white"), screen, 170,150)
        button1.draw()
        button2.draw()
    ...
    def level3(self):
        ...
        #screen.blit(roof, (0, int(height / 2),  width, int(height / 2)))
...
def pauseGame ():
    ...
    while paused:
        ...
        drawText('Paused press C to continue or Escape to quit', font, pygame.Color("white"), screen, 0,250)
...
button1 = MainButton('Start Game',210,40,(150,200),8)
button2 = ExitButton('Exit',210,40,(150,300),8)
